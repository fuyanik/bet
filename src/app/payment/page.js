...
const page = () => {
  ...
  return (
    <div className='w-screen overflow-x-hidden h-auto mb:pb-10 pb-20'>
      ...
      <div className='w-full h-full bg-[#e5e6e7] md:p-10 p-1 '>
         <div className='flex items-center justify-center w-full h-full bg-[#eeeeee] md:p-10 p-1'>
             <div className=' md:w-[670px] w-full h-full bg-white flex flex-col gap-3 md:p-4 p-2'>
